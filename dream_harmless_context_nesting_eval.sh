...
#PBS -N dream_harmless_context_nesting_eval
#PBS -o eval_logs/dream_harmless_context_nesting_eval.log
#PBS -j oe

# Evaluates Dream harmless context nesting outputs (PPL + SAR only).
# No ASR evaluation — these are benign prompts.
# Mirrors harmless_context_nesting_eval.sh (LLaDA).
# Run dream_harmless_context_nesting_gen.sh first.
...
echo ""
echo "=============================================="
echo "All Dream harmless context nesting evaluations complete."
echo "=============================================="
